...
const CreateNft: NextPage = () => {
	...
	const createNft = async () => {
		...
		const nftFile = new Moralis.File(nftMetadata.name,{base64:btoa(JSON.stringify(nftMetadata))})
				...
				<Form>
					...
					<FormElement>
						...
						<OutlinedInput 
							...
							value={form.price}
							type="number"					  
							endAdornment={<InputAdornment position="end">{form.price ? (parseFloat(form.price) * tokenPrice).toFixed(2) : "0"}€</InputAdornment>}				
						/>
					</FormElement>
					<FileSelect>
